...
parser = argparse.ArgumentParser(description='Interpolate fields in UM ancillary file for Miocene')
parser.add_argument('infile', help='input ancillary file')
parser.add_argument('outfile', help='output ancillary file for Miocene')
